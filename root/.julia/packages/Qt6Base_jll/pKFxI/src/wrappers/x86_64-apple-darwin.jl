...
export libqt6concurrent, libqt6core, libqt6dbus, libqt6gui, libqt6network, libqt6opengl, libqt6openglwidgets, libqt6printsupport, libqt6sql, libqt6test, libqt6widgets, libqt6xml
...
JLLWrappers.@declare_library_product(libqt6openglwidgets, "@rpath/QtOpenGLWidgets")
...
function __init__()
    ...
    JLLWrappers.@init_library_product(
        libqt6openglwidgets,
        "lib/QtOpenGLWidgets.framework/Versions/A/QtOpenGLWidgets",
        RTLD_LAZY | RTLD_DEEPBIND,
    )
