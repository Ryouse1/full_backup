...
set_target_properties(Qt6::WaylandClient PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libQt6WaylandClient.so.6.8.2"
  IMPORTED_SONAME_RELEASE "libQt6WaylandClient.so.6"
  )

list(APPEND _IMPORT_CHECK_TARGETS Qt6::WaylandClient )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qt6::WaylandClient "${_IMPORT_PREFIX}/lib/libQt6WaylandClient.so.6.8.2" )
