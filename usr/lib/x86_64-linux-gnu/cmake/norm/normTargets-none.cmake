...
set_target_properties(norm::norm PROPERTIES
  IMPORTED_LOCATION_NONE "${_IMPORT_PREFIX}/lib/x86_64-linux-gnu/libnorm.so.1"
  IMPORTED_SONAME_NONE "libnorm.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS norm::norm )
list(APPEND _IMPORT_CHECK_FILES_FOR_norm::norm "${_IMPORT_PREFIX}/lib/x86_64-linux-gnu/libnorm.so.1" )
...
set_target_properties(norm::norm-static PROPERTIES
  ...
  IMPORTED_LOCATION_NONE "${_IMPORT_PREFIX}/lib/x86_64-linux-gnu/libnorm.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS norm::norm-static )
list(APPEND _IMPORT_CHECK_FILES_FOR_norm::norm-static "${_IMPORT_PREFIX}/lib/x86_64-linux-gnu/libnorm.a" )
...
set_target_properties(norm::protokit PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_NONE "CXX"
  IMPORTED_LOCATION_NONE "${_IMPORT_PREFIX}/lib/x86_64-linux-gnu/libprotokit.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS norm::protokit )
list(APPEND _IMPORT_CHECK_FILES_FOR_norm::protokit "${_IMPORT_PREFIX}/lib/x86_64-linux-gnu/libprotokit.a" )
